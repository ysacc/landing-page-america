    ...
    <section ref={ref} className="download-section">
      ...
      <div className="download-main">
        {isTablet &&(
         ...
         <div className="download-header">
         <h2> {DOWNLOAD_SECTION_TEXT.header}<br /><strong className="text-strong">{DOWNLOAD_SECTION_TEXT.header2}</strong></h2>
         <p>{DOWNLOAD_SECTION_TEXT.description} <strong className="text-strong1">{DOWNLOAD_SECTION_TEXT.description1}</strong> {DOWNLOAD_SECTION_TEXT.description2} {DOWNLOAD_SECTION_TEXT.description3} {DOWNLOAD_SECTION_TEXT.description4}<strong className="text-strong1">{DOWNLOAD_SECTION_TEXT.description5}</strong></p>

       </div>
       <div className="text-buttons">
         <div className="buttons">
           <button style={{width:"300px",display:"flex",justifyContent:"start",alignItems:"center",paddingLeft:"43px"}}>TARIFARIO AMERICA</button>
           <button style={{width:"350px",display:"flex",justifyContent:"start",alignItems:"center",paddingLeft:"43px"}}>TARIFARIO CANAL N</button>
           <button style={{width:"450px",display:"flex",justifyContent:"start",alignItems:"center",paddingLeft:"43px"}}>TARIFARIO DIGITAL</button>
